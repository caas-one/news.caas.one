...
96. [Deploying apps on multiple Kubernetes clusters with Helm](https://medium.com/dailymotion/deploying-apps-on-multiple-kubernetes-clusters-with-helm-19ee2b06179e) 已翻译(@mlycore)
97. [Observability patterns](https://docs.microsoft.com/en-us/dotnet/architecture/cloud-native/observability-patterns)
98. [Cloud-Native Logging And Monitoring Pattern](https://www.magalix.com/blog/cloud-native-logging-and-monitoring-pattern)
99. [Service Mesh Series Part 3/3 – Istio and Harness](https://harness.io/2019/10/service-mesh-series-part-3-3-istio-and-harness/)
100. [Part 4: When a ‘Service Mesh Lite’ Proxy Is Right for Your Organization](https://thenewstack.io/part-4-when-a-service-mesh-lite-proxy-is-right-for-your-organization/)
101. [The State of the Service Mesh, Part 1](https://www.nginx.com/blog/state-of-service-mesh-part-1/)
